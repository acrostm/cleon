/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 638d044a2e388c2234990493f8c014aa)
// Runtime types generated with workerd@1.20260625.1 2026-06-29 nodejs_compat
interface __BaseEnv_Env {
	AUTH_STATE: KVNamespace;
	ARCHIVE_BUCKET: R2Bucket;
	BROWSER: BrowserRun;
	WORKER_ID: "cloudflare-xhs-archive-worker";
	BROWSER_DAILY_BUDGET_SECONDS: "600";
	BROWSER_DAILY_SOFT_LIMIT_SECONDS: "540";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKER_ID" | "BROWSER_DAILY_BUDGET_SECONDS" | "BROWSER_DAILY_SOFT_LIMIT_SECONDS" | "MAX_POSTS_PER_SCAN">> {}
}
